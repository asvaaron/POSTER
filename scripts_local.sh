...
python mcnemar_test.py \
  ...
  --dataset rafdb \
  --checkpoints \
    checkpoint/local_small_simple/epoch179_acc0.9237.pth \
    checkpoint/local_small_enhanced_v1/epoch191_acc0.9234.pth \
    checkpoint/local_base_simple/epoch222_acc0.9276.pth \
    checkpoint/local_base_enhanced_v1/epoch219_acc0.9247.pth \
    checkpoint/local_large_simple/epoch200_acc0.925.pth \
